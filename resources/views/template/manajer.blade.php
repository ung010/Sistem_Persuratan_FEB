            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    <li class="nav-item dropdown">
                        @auth
                        <li class="nav-item">
                            <a class="nav-link" href="/manajer">{{ auth()->user()->nama }}</a>
                        </li>
                    @endauth
                    </li>
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/srt_mhw_asn/manajer">Surat keterangan untuk anak ASN</a>
                            </li>
                            <li><a class="dropdown-item" href="/srt_masih_mhw/manajer">Surat Keterangan Masih
                                    Mahasiswa</a></li>
                            <li><a class="dropdown-item" href="/srt_magang/manajer">Surat Magang</a></li>
                            <li><a class="dropdown-item" href="/srt_izin_plt/manajer">Surat Izin Penelitian</a></li>
                            <li><a class="dropdown-item" href="/srt_pmhn_kmbali_biaya/manajer">Surat Permohonan
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/riwayat_srt/manajer/srt_mhw_asn">Surat keterangan untuk anak ASN</a>
                            </li>
                            <li><a class="dropdown-item" href="/riwayat_srt/manajer/srt_masih_mhw">Surat Keterangan Masih
                                    Mahasiswa</a></li>
                            <li><a class="dropdown-item" href="/riwayat_srt/manajer/srt_magang">Surat Magang</a></li>
                            <li><a class="dropdown-item" href="/riwayat_srt/manajer/srt_izin_plt">Surat Izin Penelitian</a></li>
                            <li><a class="dropdown-item" href="/riwayat_srt/manajer/srt_pmhn_kmbali_biaya">Surat Permohonan
                                    Pengembalian Biaya Pendidikan</a></li>
