                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="dropdown-item" href="/srt_mhw_asn/supervisor">Surat keterangan untuk anak
                                    ASN</a></li>
                            <li><a class="dropdown-item" href="/srt_masih_mhw/supervisor">Surat Keterangan Masih
                                    Mahasiswa</a></li>
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                            ...
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    <li><a class="dropdown-item" href="/legalisir/sv/dikirim/ijazah">Ijazah</a>
                                    </li>
                                    <li><a class="dropdown-item"
                    ...
                    <li class="nav-item dropdown">
                        <a class="nav-link dropdown-toggle" href="/supervisor_akd/manage_admin">
                            Manajemen Admin
                        </a>
                    </li>
                    <li class="nav-item dropdown">
