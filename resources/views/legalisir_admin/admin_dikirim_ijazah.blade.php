...
@section('inti_data')
    ...
    <body>
        ...
        <form method="GET" action="{{ route('legalisir_admin.admin_dikirim_ijazah_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/legalisir/admin/dikirim/ijazah">Reload</a>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->role_surat == 'admin')
                                    <a href="{{ url('/legalisir/admin/dikirim/ijazah/cek_legal/' . $item->id) }}" class="btn btn-warning btn-sm">Cek Data</a>
                                @else
                            ...
                            <td>
                                @if ($item->role_surat == 'manajer_sukses')
                                    <a href="{{ url('/legalisir/admin/dikirim/ijazah/download/' . $item->id) }}" class="btn btn-primary btn-sm">Unduh</a>
                                @else
