        ...
        <div class="container py-5">
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 d-grid">
                    <form action="{{ route('legalisir_admin.admin_dikirim_transkrip_setuju', $legalisir->id) }}" method="POST">
                        @csrf
                ...
                <div class="mb-3 d-grid">
                    <a href='/legalisir/admin/dikirim/transkrip' class="btn btn-info">Kembali</a>
                </div>
            </div>
        </div>
        ...
        <div class="modal fade" id="tolakModal" tabindex="-1" aria-labelledby="tolakModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <form action="{{ route('legalisir_admin.admin_dikirim_transkrip_tolak', $legalisir->id) }}" method="POST">
                        @csrf
