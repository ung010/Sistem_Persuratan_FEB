...
@section('inti_data')
    ...
    <body>
        ...
        <form method="GET" action="{{ route('legalisir_admin.admin_ditempat_ijz_trs_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/legalisir/admin/ditempat/ijz_trs">Reload</a>
                        ...
                        <tr>
                            ...
                            <td>
                                @if ($item->role_surat == 'manajer_sukses')
                                    <a href="{{ url('/legalisir/admin/ditempat/ijz_trs/download/' . $item->id) }}" class="btn btn-primary btn-sm">
                                        Unduh
                                    </a>
                                @else
        ...
        <div class="modal fade" id="uploadModal" tabindex="-1" role="dialog" aria-labelledby="uploadModalLabel"
            ...
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ isset($item) ? route('legalisir_admin.admin_ditempat_ijz_trs_resi', $item->id) : '#' }}"
        ...
        <script>
            $('#uploadModal').on('show.bs.modal', function(event) {
                ...
                modal.find('form').attr('action', '/legalisir/admin/ditempat/ijz_trs/no_resi/' + id);
