        ...
        <div class="container py-5">
            <div class="my-3 p-3 bg-body rounded shadow-sm">
                ...
                <div class="mb-3 d-grid">
                    <form action="{{ route('legalisir_admin.admin_ditempat_ijazah_setuju', $legalisir->id) }}" method="POST">
                        @csrf
                ...
                <div class="mb-3 d-grid">
                    <a href='/legalisir/admin/ditempat/ijazah' class="btn btn-info">Kembali</a>
                </div>
            </div>
        </div>
