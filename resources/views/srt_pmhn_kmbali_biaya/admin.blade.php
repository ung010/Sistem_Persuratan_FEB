...
@section('inti_data')
    ...
    <body>
        <form method="GET" action="{{ route('srt_pmhn_kmbali_biaya.admin_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/srt_pmhn_kmbali_biaya/admin">Reload</a>
                    ...
                    <form action="" method="POST" enctype="multipart/form-data" id="uploadForm">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="file" name="srt_pmhn_kmbali_biaya" id="srt_pmhn_kmbali_biaya" class="form-control" required>
                            </div>
                        </div>
