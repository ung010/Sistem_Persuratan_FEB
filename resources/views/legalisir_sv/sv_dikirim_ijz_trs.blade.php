...
@section('inti_data')
    ...
    <body>
        ...
        <form method="GET" action="{{ route('legalisir_sv.sv_dikirim_ijz_trs_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/legalisir/sv/dikirim/ijz_trs">Reload</a>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('legalisir_sv.sv_dikirim_ijz_trs_setuju', $item->id) }}" method="POST" style="display:inline;">
                                    @csrf
