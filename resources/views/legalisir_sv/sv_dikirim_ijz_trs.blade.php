            ...
            <div class="mx-5">
                ...
                <div class="card d-inline-block">
                    <div class="card-header d-flex align-items-center">
                        <a class="btn btn-secondary" href="/legalisir/sv/dikirim/ijazah">Ijazah</a>
                        <a class="btn btn-secondary" href="/legalisir/sv/dikirim/transkrip">Transkrip</a>
                        <a class="btn btn-secondary" href="/legalisir/sv/dikirim/ijz_trs">Ijazah dan Transkrip</a>
                    </div>
                </div>
            </div>
                        ...
                        <tbody>
                            ...
                            @foreach ($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        <form action="{{ route('legalisir_sv.sv_dikirim_ijz_trs_setuju', $item->id) }}"
