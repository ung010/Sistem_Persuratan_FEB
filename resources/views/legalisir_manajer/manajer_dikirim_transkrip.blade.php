...
@section('inti_data')
    ...
    <body>
        ...
        <form method="GET" action="{{ route('legalisir_manajer.manajer_dikirim_transkrip_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/legalisir/manajer/dikirim/transkrip">Reload</a>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('legalisir_manajer.manajer_dikirim_transkrip_setuju', $item->id) }}" method="POST" style="display:inline;">
                                    @csrf
