...
@section('inti_data')
    ...
    <body>
        ...
        <form method="GET" action="{{ route('legalisir_manajer.manajer_ditempat_ijazah_search') }}">
            <input type="text" name="search" placeholder="Cari..." value="{{ request('search') }}">
            <button type="submit">Cari</button>
        </form>
        <a href="/legalisir/manajer/ditempat/ijazah">Reload</a>
                ...
                <tbody>
                    ...
                    @foreach ($data as $item)
                        <tr>
                            ...
                            <td>
                                <form action="{{ route('legalisir_manajer.manajer_ditempat_ijazah_setuju', $item->id) }}" method="POST" style="display:inline;">
                                    @csrf
