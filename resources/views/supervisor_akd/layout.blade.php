        ...
        <div class="d-flex flex-column justify-content-between h-100">
            <div class="">
                ...
                <ul class="list-unstyled ps-0">
                    ...
                    <li class="mb-1">
                        <a href="/supervisor_akd" class="link-dark"><img src="{{ asset('asset/icons/admin.png') }}"
                                alt="Icon" style="height: 16px;"> {{ auth()->user()->nama }}</a>
                    </li>
                    <li class="border-top my-3 border-dark"></li>
                    <li class="mb-1">
                        <a href="/supervisor_akd" class="link-dark"><img src="{{ asset('asset/icons/dashboard.png') }}"
