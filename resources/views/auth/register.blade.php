                    ...
                    <div class="col-6">
                        ...
                        <select class="form-select" name='jnjg_id' id="jnjg_id">
                            ...
                            @foreach ($jenjang_pendidikan as $jjg)
                                <option value="{{ $jjg->id }}"
                                    {{ $jjg->id == Session::get('jnjg_id') ? 'selected' : '' }}>{{ $jjg->nama_jnjg }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-6">
                        ...
                        <select class="form-select" name='dpt_id' id="dpt_id">
                            ...
                            @foreach ($departemen as $dpt)
                                <option value="{{ $dpt->id }}"
                                    {{ $dpt->id == Session::get('dpt_id') ? 'selected' : '' }}>{{ $dpt->nama_dpt }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                ...
                <div class="form-group mb-3 d-flex justify-content-center gap-3 px-2">
                    <div class="col-6">
                        ...
                        <select class="form-select" name='prd_id' id="prd_id">
                            ...
                            @foreach ($prodi as $prd)
                                <option value="{{ $prd->id }}"
                                    {{ $prd->id == Session::get('prd_id') ? 'selected' : '' }}>{{ $prd->nama_prd }}
                                </option>
                            @endforeach
                        </select>
                    </div>
                    <div class="col-6 d-flex flex-column gap-1">
                        <div class="d-flex gap-2">
                            <input type="radio" name="status" id="" value="mahasiswa" {{ Session::get('status') == 'mahasiswa' ? 'checked' : '' }}> Mahasiswa Aktif
                        </div>
                        <div class="d-flex gap-2">
                            <input type="radio" name="status" id="" value="alumni" {{ Session::get('status') == 'alumni' ? 'checked' : '' }}> Alumni
                        </div>
                    </div>
                </div>
